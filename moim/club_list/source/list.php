...
<html lang="ko" dir="ltr">
 ...
 <body>
   ...
   <div class="top_list" id="startdiv">
     ...
     <a href="#" onclick="call_clublist()" class="btn club_list_btn"><i class="fas fa-check" style="font-size:15px"></i>모집중인 모임</a>
   ...
   <section class="gallery" id="gallery_id">
         ...
         if (!(empty($_GET['mode']))&&(isset($_GET['mode']))){     //카테고리 별 모집모임
           ...
           <figure class="gallery_item noshow btm2_item">
             <a href="./view.php?club_num=<?=$club_num?>&mode=<?=$club_category?>" id="">
               <?php
