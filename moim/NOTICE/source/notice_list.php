   ...
   <head>
     ...
     $(document).ready(function() {
       ...
       $("#modal_write").click(function() {
         ...
         $("#tr1").append("<td class='faq_td'>작성자</td>");
         $("#tr1").append("<td>관리자</td>");
         $("#table1").append("</tr>");
         $("#table1").append("<tr id='tr2'>");
         $("#tr2").append("<td class='faq_td'>제목</td>");
         $("#tr2").append("<td><input type='text' id='notice_subject' name='notice_subject' placeholder='제목' autocomplete='off'></td>");
         $("#table1").append("</tr>");
         $("#table1").append("<tr id='tr3'>");
         $("#tr3").append("<td class='faq_td'>내용</td>");
         $("#tr3").append("<td><textarea name='notice_content' rows='2' placeholder='내용' cols='140'></textarea></td>");
         $("#table1").append("</tr>");
       ...
       $(".modal_view").click(function() {
         ...
         .done(function(result) {
           ...
           $("#tr1").append("<td>"+notice_hidden_id+"</td>");
           $("#table1").append("</tr>");
           $("#table1").append("<tr id='tr2'>");
           $("#tr2").append("<td class='notice_td'>조회</td>");
           $("#tr2").append("<td>"+notice_hidden_hit+"</td>");
           $("#table1").append("</tr>");
           $("#table1").append("<tr id='tr3'>");
           $("#tr3").append("<td class='notice_td'>작성일</td>");
           $("#tr3").append("<td>"+notice_hidden_date+"</td>");
           $("#table1").append("</tr>");
           $("#table1").append("<tr id='tr4'>");
           $("#tr4").append("<td class='notice_td'>제목</td>");
           $("#tr4").append("<td>"+notice_hidden_subject+"</td>");
           $("#table1").append("</tr>");
           $("#table1").append("<tr id='tr5'>");
           $("#tr5").append("<td class='notice_td'>첨부파일</td>");
           if(notice_hidden_copied!=""){
             $("#tr5").append("<td>▷첨부파일 : "+notice_hidden_file+" &nbsp; ("+notice_hidden_size+")<a href='notice_query.php?mode=download&notice_num="+notice_hidden_num+"'>저장</a></td>");
           }
           $("#table1").append("</tr>");
