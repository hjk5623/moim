    ...
    <div class="body">
      ...
      <form name="tx_editor_form" id="tx_editor_form" action="./admin_query.php?mode=clubinsert" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        <div id="write_form">
          ...
          <table id="" style="margin:50px;">
            <tr>
              <td>모임이름</td>
              <td><input type="text" name="club_name" value=""> </td>
            </tr>
            <tr>
              <td id="write_td">카테고리</td>
              <td><input type="text" name="club_category" value=""></td>
            </tr>
            <tr>
              <td id="write_td">모임장소</td>
              <td><input id="address1" type="text" name="club_rent_info1" value="" onclick="execDaumPostcode()" size="50"></td>
              <td><input id="address2" type="text" name="club_rent_info2" value=""></td>
            </tr>
            <tr>
              <td id="write_td">모집정원</td>
              <td><input type="number" name="club_to" value=""></td>
            </tr>
            <tr>
              <td>모집시작일</td>
              <td><input type="text" name="club_start" value="" id="datepicker1"></td>
            </tr>
            <tr>
              <td>모집종료일</td>
              <td><input type="text" name="club_end" value="" id="datepicker2"></td>
            </tr>
            <tr>
              <td>가격</td>
              <td><input type="number" name="club_price" value=""></td>
            </tr>
            <tr>
              <td>수업일정</td>
              <td><input type="text" name="club_schedule" value=""></td>
            </tr>
            <tr>
              <td>사진</td>
        ...
        <!--end of write_form -->
        <!-- 에디터 컨테이너 시작 -->
        <div id="tx_trex_container" class="tx-editor-container" style="margin:50px">
          <!-- 사이드바 -->
