...
if(!move_uploaded_file($upfile_tmp_name, $uploaded_file)){
  echo "<script>alert('서버 전송에러');</script>";
...
// <![CDATA[
    function initUploader(){
        ...
        var _mockdata = {
            'imageurl': '<?php echo "http://localhost/moim/admin/source/data/".$copied_file_name;?>',    //경로쓸때 주의
            'filename': '<?php echo $copied_file_name; ?>',
            'filesize': '<?php echo $upfile_size; ?>',
            'imagealign': 'C',
            'originalurl': '<?php echo "http://localhost/moim/admin/source/data/".$copied_file_name; ?>', //경로쓸때 주의
            'thumburl': '<?php echo "http://localhost/moim/admin/source/data/".$copied_file_name; ?>' //경로쓸때 주의
        };
